...
export class CornerstoneDirective implements OnInit, AfterViewChecked {
  ...
  public displayImage(image) {
    ...
    this.instanceNumber =
      image.data.intString('x00200011') +
      '/' +
      image.data.intString('x00200013');
...
// import * as cornerstone from 'cornerstone-core';
// import * as cornerstoneMath from 'cornerstone-math';
// import * as cornerstoneTools from '../../node_modules/cornerstone-tools/dist/cornerstoneTools';
...
//   public previousImage() {
//     if (this.imageList.length > 0) {
//       // go back to previous idx
//       this.currentIndex--;

//       // if we already at the first image
//       if (this.currentIndex < 0) {
//         this.currentIndex = 0;
//       }
//       this.displayImage(this.imageList[this.currentIndex]);
...
//       // handle edge case when index is bigger or equal to length
//       if (this.currentIndex >= this.imageList.length) {
//         this.currentIndex = this.imageList.length - 1;
//       }
//       this.displayImage(this.imageList[this.currentIndex]);
...
//     // save image obj to currentImage
//     this.currentImage = image;
